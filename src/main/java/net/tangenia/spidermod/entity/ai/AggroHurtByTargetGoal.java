...
public class AggroHurtByTargetGoal extends TargetGoal {
    ...
    public AggroHurtByTargetGoal(PathfinderMob pMob, Class<?>... pToIgnoreDamage) {
        super(pMob, true);
    ...
    public AggroHurtByTargetGoal setAlertOthers(Class<?>... pReinforcementTypes) {
    ...
    public void start() {
        ...
        if(this.mob instanceof WanderingSpiderEntity && !((WanderingSpiderEntity) this.mob).isAggro()) {
            ((WanderingSpiderEntity) this.mob).setAggro(true);
        }
