...
public class WolfSpiderAttackGoal extends MeleeAttackGoal {
    private final WolfSpiderEntity entity;
    private int attackDelay = 15;
    private int ticksUntilNextAttack = 15;
    private boolean shouldCountTilNextAttack = false;

    public WolfSpiderAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        entity = (WolfSpiderEntity) pMob;
    }
