...
public class BlackWidowFangItem extends Item {

    public BlackWidowFangItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if(!pLevel.isClientSide) {
            pPlayer.addEffect(new MobEffectInstance(ModEffects.BLACK_WIDOW_EFFECT.get(), 80, 1));
        }
